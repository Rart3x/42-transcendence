...
export async function addOperator(channelName : string, operatorName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/${channelName}/add/operator/${operatorName}`, {
      method: "POST",
      headers: {
...
export async function checkPass(channelName: string, password: string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/${channelName}/checkPass`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function createChannel(channelName : string, userName : string, invitedUserName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/${channelName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function createEmptyChannel(channelName : string, userName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/create/${channelName}/empty`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function joinChannel(channelName : string, userName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/${channelName}/join/${userName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function setAdmin(channelName : string, adminName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/${channelName}/set/admin/${adminName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function setPassword(channelName : string, password : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/${channelName}/set/password`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function unsetPassword(channelName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/${channelName}/unset/password`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function addFriend(userName : string, friendName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/user/friend/add/${friendName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function insertMessageToChannel(channelName : string, message_text : string, user : User, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/message/${channelName}/post/message`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function createPrivateMessage(userName1: string, userName2: string, messageContent: string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/privateMessage/create/${userName1}/${userName2}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function banUserFromChannel(channelName : string, userName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/${channelName}/ban/${userName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function blockUser(userName : string, blockedUserName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/user/${userName}/block/${blockedUserName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function unblockUser(userName : string, unblockedUserName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/user/${userName}/unblock/${unblockedUserName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function insertUser(userName: string, image: string, cookie: string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/user`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function muteUserFromChannel(channelName : string, userName : string, duration : number, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/channel/${channelName}/mute/${userName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function setStatus(userName : string, status : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/user/${userName}/setStatus`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function updateUsername(userName : string, newUserName : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/user/updateUsername/${userName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function createGameRoom(hostPlayerName : string, invitedPlayerName: string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/gameroom/createGameRoomInvitation/${hostPlayerName}/${invitedPlayerName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function setClientSocket(userName : string, socket : string, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/user/socket/${socket}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function updateA2F(userName : string, A2F : boolean, jwtToken: string) {
  try {
    const response = await fetch(`http://2C3.42angouleme.fr:3000/user/updateA2F/${userName}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${jwtToken}`
...
export async function updateImage(userName : string, image : string, jwtToken: string) {
  try {
    ...
    const response = await fetch(`http://2C3.42angouleme.fr:3000/user/updateImage/${userName}`, {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${jwtToken}`
      },
